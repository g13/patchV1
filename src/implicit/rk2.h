...
__device__
__forceinline__
_float get_a(_float gE, _float gI, _float gL) {
    return gE + gI + gL;
}

__device__
__forceinline__
_float get_b(_float gE, _float gI, _float gL) {
    return gE * vE + gI * vI + gL * vL;
}

__device__
__forceinline__
_float comp_spike_time(_float v,_float v0, _float dt, _float t0 = 0.0) {
    return t0 + (vT-v0)/(v-v0)*dt;
}

__device__
__forceinline__
_float recomp_v0(_float A, _float B, _float rB) {
...
__device__
__forceinline__
void Runge_Kutta_2::compute_spike_time(_float dt, _float t0) {
    tsp = comp_spike_time(v, v0, dt, t0);
}

__device__
__forceinline__
void Runge_Kutta_2::set_p0(_float gE, _float gI, _float gL) {
    a0 = get_a(gE, gI, gL);
    b0 = get_b(gE, gI, gL); 
}
...
__device__
__forceinline__
void Runge_Kutta_2::set_p1(_float gE, _float gI, _float gL) {
    a1 = get_a(gE, gI, gL);
    b1 = get_b(gE, gI, gL); 
}
